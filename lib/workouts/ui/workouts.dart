              ...
              child: SizedBox(
                ...
                child: Center(
                  child: ListTile(
                    ...
                    subtitle: Text(DateHelper.isWithinCurrentWeek(workouts[index].date)
                        ? DateHelper.getDayOfWeekFromTimestamp(workouts[index].date, isForDate: true)
                        : DateHelper.dateFormatter(workouts[index].date)),
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
